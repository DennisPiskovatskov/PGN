...
{
  cat >"$1" <<EOL
  package javaee.solutions.pgn.chessclub.generated;
...
java -cp "$antlr_jar" org.antlr.v4.Tool "$grammar_file" -package "javaee.solutions.pgn.chessclub.generated"
...
# Move .java files to ...
generated="../target/generated-sources/antlr4/javaee/solutions/pgn/chessclub/generated"
rm -rf $generated
mkdir -p $generated
mv *.java $generated
mv *.tokens $generated

target="../target/javaee/solutions/pgn/chessclub/generated"
rm -rf $target
mkdir -p $target
mv *.class $target
...
cd ../target
pwd
java -cp "$antlr_jar:." "javaee.solutions.pgn.chessclub.generated.$main_class_name"
