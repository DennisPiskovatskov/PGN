...
/**
 * Copy from
 * {@link https://github.com/rahular/chess-misc/blob/master/JavaStockfish/src/com/rahul/stockfish/StockfishTest.java}
 */
public class StockfishTest {

    public static void main(final String[] args) {
        final Stockfish client = new Stockfish();
        final String FEN = "8/6pk/8/1R5p/3K3P/8/6r1/8 b - - 0 42";
