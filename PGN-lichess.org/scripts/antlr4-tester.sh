...
{
  cat >"$1" <<EOL
  package javaee.solutions.pgn.lichess.generated;
...
java -cp "$antlr_jar" org.antlr.v4.Tool "$grammar_file" -package "javaee.solutions.pgn.lichess.generated"
...
# Move .java files to ...
generated="../target/generated-sources/antlr4/javaee/solutions/pgn/lichess/generated"
rm -rf $generated
mkdir -p $generated
mv *.java $generated
mv *.tokens $generated

target="../target/javaee/solutions/pgn/lichess/generated"
rm -rf $target
mkdir -p $target
mv *.class $target
...
cd ../target
pwd
java -cp "$antlr_jar:." "javaee.solutions.pgn.lichess.generated.$main_class_name"
